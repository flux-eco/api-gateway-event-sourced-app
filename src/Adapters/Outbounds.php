...
class Outbounds implements Ports\Outbounds
{
     ...
     * @throws \JsonException
     */
    final public function updateAggregateRoot(
        string $correlationId,
        string $actorEmail,
        string $aggregateId,
        string $aggregateName,
    ...
    final public function deleteAggregateRoot(
        string $correlationId,
        string $actorEmail,
        string $aggregateId,
        string $aggregateName
    ...
    final public function getProjectedItemList(string $projectionName, array $queryParameter) : array
    {
        return fluxProjection\getItemList($projectionName, $queryParameter['parentId'], $queryParameter['offset'],
            $queryParameter['limit'], $queryParameter['orderBy'], $queryParameter['search']);
    }
